...
namespace mtm{
    ...
    public:
        ...
        /**
           ...
           *
           * @throw
           *      IllegalArgument - if other is NULLg
           */
        ...
        /**
           ...
           *
           * @return:
           *       SOLDIER - if the calling derived object is Soldier object
           *       MEDIC   - if the calling derived object is Medic object
           *       SNIPER  - if the calling derived object is Sniper object
           */
        ...
        /**
           ...
           *
           * @return:
           *       CROSSFITTERS - if the calling Character is on the Crossfitters team
           *       POWERLIFTERS - if the calling Character is on the Powerlifters team
           */
        Team getTeam() const;
        ...
        /**
           ...
           *
           * @return
           *       true  - if distance is smaller than the Character's moving range.
           *       false - otherwise.
           */
        ...
        /**
           ...
           *
           * @return
           *        true  - if attack is legal range-wise.
           *        false - otherwise.
           */
        ...
        /**
           ...
           *
           * @return
           *        true  - if attack is legal type-wise.
           *        false - otherwise.
           */
        ...
        /**
           ...
           *
           * @return
           *        true  - if attack is legal position-wise.
           *        false - otherwise.
           */
        ...
        /**
           ...
           *
           * @return
           *        true  - if the caller Character has enough ammunition to launch the attack.
           *        false - otherwise.
           */
        ...
        /**
           ...
           *
           * @return
           *        true  - if the caller Character has more than 0 health points.
           *        false - otherwise.
           */
        bool isAlive() const;
        ...
        /**
           ...
           *
           * @return
           *        true  - if gp is in range of collateral damage of the attack that was launched on direct_target.
           *        false - otherwise.
           */
